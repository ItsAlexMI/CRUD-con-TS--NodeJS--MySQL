        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (usuario) {
                    ...
                    res.status(404).json({
                        message: "No existe el usuario con el id ".concat(id),
                    });
                }
                return [2 /*return*/];
        }
...
var postUsuarios = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, usuario_1.default.create({
                        nombre: body.nombre,
                        email: body.email,
                        estado: body.estado,
                    })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, usuario.destroy()];
            case 2:
                //await usuario.update({ estado: false });
                _a.sent();
                res.status(200).json({
